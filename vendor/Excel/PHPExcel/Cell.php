...
require_once './vendor/Excel/PHPExcelCell/DataValidation.php';

/** PHPExcel_Cell_Hyperlink */
require_once './vendor/Excel/PHPExcelCell/Hyperlink.php';

/** PHPExcel_Worksheet */
require_once './vendor/Excel/PHPExcelWorksheet.php';

/** PHPExcel_Calculation */
require_once './vendor/Excel/PHPExcelCalculation.php';

/** PHPExcel_Cell_IValueBinder */
require_once './vendor/Excel/PHPExcelCell/IValueBinder.php';

/** PHPExcel_Cell_DefaultValueBinder */
require_once './vendor/Excel/PHPExcelCell/DefaultValueBinder.php';
