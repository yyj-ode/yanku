...
{	
	...
	private static $_searchLocations = array(
		array( 'type' => 'IWriter', 'path' => './vendor/Excel/PHPExcelWriter/{0}.php', 'class' => 'PHPExcel_Writer_{0}' ),
		array( 'type' => 'IReader', 'path' => './vendor/Excel/PHPExcelReader/{0}.php', 'class' => 'PHPExcel_Reader_{0}' )
	);
	 ...
	 * @param string $location		Example: ./vendor/Excel/PHPExcelWriter/{0}.php
