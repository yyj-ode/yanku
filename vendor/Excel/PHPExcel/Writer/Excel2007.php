...
/** PHPExcel_HashTable */
require_once './vendor/Excel/PHPExcelHashTable.php';

/** PHPExcel_IComparable */
require_once './vendor/Excel/PHPExcelIComparable.php';

/** PHPExcel_Worksheet */
require_once './vendor/Excel/PHPExcelWorksheet.php';

/** PHPExcel_Cell */
require_once './vendor/Excel/PHPExcelCell.php';

/** PHPExcel_IWriter */
require_once './vendor/Excel/PHPExcelWriter/IWriter.php';

/** PHPExcel_Shared_XMLWriter */
require_once './vendor/Excel/PHPExcelShared/XMLWriter.php';

/** PHPExcel_Writer_Excel2007_WriterPart */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/WriterPart.php';

/** PHPExcel_Writer_Excel2007_StringTable */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/StringTable.php';

/** PHPExcel_Writer_Excel2007_ContentTypes */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/ContentTypes.php';

/** PHPExcel_Writer_Excel2007_DocProps */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/DocProps.php';

/** PHPExcel_Writer_Excel2007_Rels */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Rels.php';

/** PHPExcel_Writer_Excel2007_Theme */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Theme.php';

/** PHPExcel_Writer_Excel2007_Style */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Style.php';

/** PHPExcel_Writer_Excel2007_Workbook */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Workbook.php';

/** PHPExcel_Writer_Excel2007_Worksheet */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Worksheet.php';

/** PHPExcel_Writer_Excel2007_Drawing */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Drawing.php';

/** PHPExcel_Writer_Excel2007_Comments */
require_once './vendor/Excel/PHPExcelWriter/Excel2007/Comments.php';
